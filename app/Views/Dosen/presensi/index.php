                                                        ...
                                                        <tbody>
                                                            <?php foreach ($presensi as $mk) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $mk['status'] ?></td>
                                                                    <td>
                                                                        <button data-bs-target="#editModal<?= $mk['id_presensi'] ?>" data-bs-toggle="modal" class="btn btn-primary btn-sm text-white">Edit</button>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach ?>
                                                        </tbody>
    ...
    <div class="modal fade" id="editModal<?= $mk['id_presensi'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('dosen/waktupresensi/update-kehadiran') ?>" method="POST">
                    <?= csrf_field() ?>
